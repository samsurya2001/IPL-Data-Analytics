...
Conditional Inference tree (Model fitting and visualization)
...
Doing predictions on the test data and showing the confusion matrix
...
Evaluation of model by using accuracy
...
Confusion matrix with all evaluation metrics
